...
public class MainAnalysis {
    ...
    public Vector maint(double price) {
        ...
        for(int i=0;i<6;i++){
            int one = (int)(Math.random()*9000)+1000;
            int two = (int)(Math.random()*9000)+1000;
            int three = (int)(Math.random()*9000)+1000;
            int four = (int)(Math.random()*9000)+1000;
            int five = (int)(Math.random()*9000)+1000;
            trainingSet.addElement(new SupervisedTrainingElement(new double[]{one / daxmax, two / daxmax, three / daxmax, four / daxmax}, new double[]{five / daxmax}));
        }
...
//      
        ...
        Vector<Double> networkOutput = null;
